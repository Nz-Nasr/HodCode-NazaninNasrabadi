...
<head>
    ...
    <?php wp_head(); ?> <script src="https://cdn.jsdelivr.net/npm/@tailwindcss/browser@4"></script>
</head>
    ...
    <header class="bg-white border-b border-gray-300">
        <div class="max-w-screen-xl mx-auto px-4 py-4 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                <a href="contact.php" class="cursor-pointer text-gray-800 hover:text-orange-300">ارتباط با ما</a>
